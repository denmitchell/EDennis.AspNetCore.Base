truncate table dbo_history.AgencyInvestigatorCheck;
declare @jack varchar(255) = 'jack@hill.org'
declare @jill varchar(255) = 'jill@hill.org'

insert into dbo_history.AgencyInvestigatorCheck(Id, SysStart, EmployeeId, DateCompleted, Status, SysEnd, SysUser, SysUserNext)
