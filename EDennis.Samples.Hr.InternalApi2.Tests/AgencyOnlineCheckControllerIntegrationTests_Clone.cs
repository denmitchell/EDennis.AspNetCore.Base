...
namespace EDennis.Samples.Hr.InternalApi2.Tests {
    ...
    public class AgencyOnlineCheckControllerIntegrationTests_Clone : CloneIntegrationTests<Startup> {
        ...
        public AgencyOnlineCheckControllerIntegrationTests_Clone(ITestOutputHelper output, CloneWebApplicationFactory<Startup> factory)
            : base(output, factory) { }
