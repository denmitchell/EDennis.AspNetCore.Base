...
namespace EDennis.Samples.ApiConfigsApi.Apis {
    public class Api1 : SecureApiClient {
        ...
        public Api1(IHttpClientFactory httpClientFactory, IOptionsMonitor<AspNetCore.Base.Apis> apis, IScopeProperties scopeProperties, ISecureTokenService secureTokenService, IWebHostEnvironment env, ILogger<Api1> logger) : base(httpClientFactory, apis, scopeProperties, secureTokenService, env, logger) {
