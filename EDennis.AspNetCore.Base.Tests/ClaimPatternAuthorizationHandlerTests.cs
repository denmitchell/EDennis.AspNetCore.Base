...
namespace EDennis.AspNetCore.Base.Security {
    public class ClaimPatternAuthorizationHandlerTests {
        ...
        [InlineData("AB", "-AB", 1)]
        [InlineData("AB", "-AC", 2)]
        [InlineData("AB", "-A*", 3)]     [InlineData("AB", "AB", 4)]
        [InlineData("AB", "A*", 5)]      [InlineData("AB", "-AC", 6)]
        /*[InlineData("AB", "A*", 5)]*/  [InlineData("AB", "-AB", 7)]
        [InlineData("ABC", "A*", 8)]     [InlineData("ABC", "-AB*", 9)]   [InlineData("ABC", "ABC", 10)]
        /*[InlineData("ABC", "A*", 8)]   [InlineData("ABC", "-AB*", 9)]*/ [InlineData("ABC", "ABD", 11)]
        [InlineData("ABC", "-A*", 12)]   [InlineData("ABC", "AB*", 13)]    [InlineData("ABC", "-ABC", 14)]
        /*[InlineData("ABC", "-A*", 12)] [InlineData("ABC", "AB*", 13)]*/  [InlineData("ABC", "-ABD", 15)]
