...
namespace EDennis.AspNetCore.Base.Testing {
    ...
    public class MockClientMiddleware {
        ...
        /// <returns></returns>
        public async Task InvokeAsync(HttpContext context, IOptionsMonitor<MockClients> mockClients, 
    ...
    /// </summary>
    public static class IApplicationBuilder_MockClientExtensionMethods {
        ...
        public static IApplicationBuilder UseMockClient(
                this IApplicationBuilder app) {
            return app.UseMiddleware<MockClientMiddleware>();
        }
    }
}
