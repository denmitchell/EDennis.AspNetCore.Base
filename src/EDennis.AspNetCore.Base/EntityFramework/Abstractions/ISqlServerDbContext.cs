...
namespace EDennis.AspNetCore.Base.EntityFramework {
    ...
    public static class ISqlServerDbContextExtensions {
        ...
        private static List<StoredProcedureDef> _spDefs;
        ...
        /// </summary>
        public static List<TResult> GetFromStoredProcedure<TContext, TResult>(this ISqlServerDbContext<TContext> context,  string spName,
            IEnumerable<KeyValuePair<string, string>> parms)
            where TContext : DbContext {
            ...
            if (context.Database.CurrentTransaction is IDbContextTransaction trans) {
                ...
                result = cxn.Query<TResult>(sql: $"{spName}",
                    param: dynamicParameters,
                    transaction: dbTrans,
                    commandType: CommandType.StoredProcedure);
        ...
        /// Retrieves a result via a parameterized stored procedure.
        /// </summary>
        public static async Task<List<TResult>> GetFromStoredProcedureAsync<TContext,TResult>(this ISqlServerDbContext<TContext> context,  string spName,
            IEnumerable<KeyValuePair<string, string>> parms)
            where TContext : DbContext {
            ...
            if (context.Database.CurrentTransaction is IDbContextTransaction trans) {
                ...
                result = await cxn.QueryAsync<TResult>(sql: $"{spName}",
                    param: dynamicParameters,
                    transaction: dbTrans,
                    commandType: CommandType.StoredProcedure);
        ...
        private static void BuildStoredProcedureDefs<TContext>(ISqlServerDbContext<TContext> context)
            where TContext : DbContext {
