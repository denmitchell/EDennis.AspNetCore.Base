...
namespace EDennis.AspNetCore.Base.Web {
    ...
    public abstract class SqlServerStoredProcedureController<TContext> : ControllerBase
        ...
        public async Task<IActionResult> GetJsonFromJsonStoredProcedureAsync([FromQuery] string spName, Dictionary<string,string> parameters){
        ...
        private Dictionary<string, object> ConvertParameters(Dictionary<string,string> parameters){
            return parameters
                ...
                .ToDictionary(q => q.Key, q => (object)q.Value[0]);
        }
