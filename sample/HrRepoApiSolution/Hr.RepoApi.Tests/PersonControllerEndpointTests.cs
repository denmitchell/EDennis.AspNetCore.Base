...
namespace Hr.RepoApi.Tests {
    ...
    public class PersonControllerEndpointTests 
        : RepoControllerEndpointTests<Person, L.Program, Launcher.Launcher> {

        public PersonControllerEndpointTests(ITestOutputHelper output,
