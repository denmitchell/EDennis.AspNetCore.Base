...
namespace EDennis.Samples.InternalApi2.Tests {
    ...
    public class AgencyOnlineCheckRepoUnitTests_TestingTransaction : TransactionTest<AgencyOnlineCheckContext> {

        private AgencyOnlineCheckRepo _repo;
        private readonly ITestOutputHelper _output;

        public AgencyOnlineCheckRepoUnitTests_TestingTransaction(ITestOutputHelper output) {
