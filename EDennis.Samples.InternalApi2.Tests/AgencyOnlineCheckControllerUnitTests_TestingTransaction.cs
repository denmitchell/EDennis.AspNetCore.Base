...
namespace EDennis.Samples.InternalApi2.Tests {
    ...
    public class AgencyOnlineCheckControllerUnitTests_TestingTransaction : TransactionTest<AgencyOnlineCheckContext> {

        private AgencyOnlineCheckController _controller;
        private AgencyOnlineCheckRepo _repo;
        private readonly ITestOutputHelper _output;

        public AgencyOnlineCheckControllerUnitTests_TestingTransaction(ITestOutputHelper output) {
